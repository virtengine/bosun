...
import { KanbanBoard } from "../../../ui/components/kanban-board.js";
import { VoiceMicButton, VoiceMicButtonInline } from "../../../ui/modules/voice.js";
import {
...
export async function openTaskWorkflowRun(run, deps = {}) {
  ...
  if (!openRuns) {
    const wfMod = await import("../../../ui/tabs/workflows.js");
